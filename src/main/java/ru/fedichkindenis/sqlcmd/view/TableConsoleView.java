...
/**
 * Декоратор для отображения информации из базы данных в виде таблиц консоли
 * Для корректного отображение в консоли должен быть установлен шрифт Courier New
 */
