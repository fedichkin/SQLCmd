    ...
    public void testCorrectCommandFormat() throws Exception {
        ...
        shouldPrintView(
                "[Команда: connect, " +
                        ...
                        "\tПример команды: data-table|my_table, " +
                        ...
                        "\tПример команды: insert-row|my_table|id|1|name|user, " +
                        "Команда: update-row, " +
                        ...
                        "\tПример команды: update-row|my_table|name|admin|!IF|id|=|1, " +
                        ...
                        "\tПример команды: delete-row|my_table|!IF|id|<|5, " +
                        ...
                        "\tПример команды: user-query|<insert into my_table (id, name) values(2, 'Peter'), " +
